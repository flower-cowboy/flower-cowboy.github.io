...
function att_fetchData() {
  fetch("JSONS/Charlotte_AT&T.json")
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
function spectrum_fetchData() {
  fetch("JSONS/Charlotte_Spectrum.json")
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
var map = new L.Map('map', {
  center: new L.LatLng(35.227085, -80.843124), // HERE is where the cities Lat and Long go to center the map
  minZoom: 9,
  maxZoom: 15,
  zoom: 10,
