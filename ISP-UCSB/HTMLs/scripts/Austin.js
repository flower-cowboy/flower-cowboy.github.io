...
function spectrum_fetchData() {
  fetch("JSONS/Austin_Spectrum.json")
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
var map = new L.Map('map', {
  center: new L.LatLng(30.266666, -97.733330), // HERE is where the cities Lat and Long go to center the map
  minZoom: 9,
  maxZoom: 15,
  zoom: 10,
