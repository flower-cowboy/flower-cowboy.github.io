...
function att_fetchData() {
  fetch("JSONS/Louisville_AT&T.json")  // ****** CHANGES MADE HERE ****** //
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
function spectrum_fetchData() {
  fetch("JSONS/Louisville_Spectrum.json")    // ****** CHANGES MADE HERE ****** //
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
var map = new L.Map('map', {
  center: new L.LatLng(38.2527, -85.7585),  // ****** CHANGES MADE HERE ****** //
  minZoom: 9,
  maxZoom: 15,
  zoom: 10,
