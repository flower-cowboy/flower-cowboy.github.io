...
function att_fetchData() {
  fetch("JSONS/Birmingham_AT&T.json")
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
function spectrum_fetchData() {
  fetch("JSONS/Birmingham_Spectrum.json")
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
var map = new L.Map('map', {
  center: new L.LatLng(33.5186, -86.8104), // HERE is where the cities Lat and Long go to center the map
  minZoom: 9,
  maxZoom: 15,
  zoom: 10,
