...
// Dont forget to change the starting coordinates to reflect the city. 
...
function fetchData() {
  fetch("JSONS/Virginia_Beach_Cox.json") // ****** CHANGES MADE HERE ****** //
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
var map = new L.Map('map', {
  center: new L.LatLng(36.8516, -75.9792), // ****** CHANGES MADE HERE ****** //
  minZoom: 9,
  maxZoom: 15,
  zoom: 10,
