...
function att_fetchData() {
  fetch("JSONS/Oklahoma_AT&T.json")  // ****** CHANGES MADE HERE ****** //
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
function spectrum_fetchData() {
  fetch("JSONS/Oklahoma_Cox.json")    // ****** CHANGES MADE HERE ****** //
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
var map = new L.Map('map', {
  center: new L.LatLng(35.4676, -97.508469),  // ****** CHANGES MADE HERE ****** //
  minZoom: 9,
  maxZoom: 15,
  zoom: 10,
