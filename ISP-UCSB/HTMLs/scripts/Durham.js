...
function att_fetchData() {
  fetch("JSONS/Durham_Frontier.json")  // ****** CHANGES MADE HERE ****** //
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
function spectrum_fetchData() {
  fetch("JSONS/Durham_Spectrum.json")    // ****** CHANGES MADE HERE ****** //
      .then((res) => {
      return res.json();
  })
  .then((data) => {
...
var map = new L.Map('map', {
  center: new L.LatLng(35.994034, -78.898621),  // ****** CHANGES MADE HERE ****** //
  minZoom: 9,
  maxZoom: 15,
  zoom: 10,
